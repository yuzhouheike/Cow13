...
#import "OriginateController.h"
@interface OriginateController ()<SDCycleScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation OriginateController
