...
#import "JiaoDianController.h"
#import "JiaoDianCell.h"
#import "NewsController.h"


@interface JiaoDianController ()<SDCycleScrollViewDelegate,UITableViewDataSource, UITableViewDelegate>
...
@implementation JiaoDianController
...
- (UITableView *)tableView {
    ...
    if (!_tableView) {
        ...
        [_tableView registerNib:[UINib nibWithNibName:NSStringFromClass([JiaoDianCell class]) bundle:nil] forCellReuseIdentifier:@"cellID"];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.row != 0) {
        ...
        [self.navigationController pushViewController:[NewsController new
                                                       ] animated:YES];
    }
}
